...
public class BarcodeScannerProcessor extends VisionProcessorBase<List<Barcode>> {
  ...
  public BarcodeScannerProcessor(Context context) {
    ...
    //BarcodeScannerOptions options = new BarcodeScannerOptions.Builder().setBarcodeFormats(Barcode.FORMAT_PDF417,
            //Barcode.FORMAT_CODE_39, Barcode.FORMAT_QR_CODE, Barcode.FORMAT_DATA_MATRIX, Barcode.FORMAT_EAN_13, Barcode.FORMAT_UPC_A).build();
  ...
  private static void logExtrasForTesting(Barcode barcode) {
    if (barcode != null) {
      ...
      Log.v(MANUAL_TESTING_LOG, "campo 1: " +doc.getDocumentNumber());
      Log.v(MANUAL_TESTING_LOG, "campo 2: " +doc.getFullname());
      Log.v(MANUAL_TESTING_LOG, "campo 3: " +doc.getGender());
      Log.v(MANUAL_TESTING_LOG, "campo 4: " +doc.getBloodType());
      Log.v(MANUAL_TESTING_LOG, "campo 5: " +doc.getDateOfBirth());
